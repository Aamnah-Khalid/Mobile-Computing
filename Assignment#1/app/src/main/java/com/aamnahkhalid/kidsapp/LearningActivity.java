...
public class LearningActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "onCreate: Learning Activity");
    ...
    protected void onResume(){
        super.onResume();
        Log.d(TAG, " onResume Learning Activity");
    }
    ...
    protected void onPause(){
        super.onPause();
        Log.d(TAG, " onPause Learning Activity");
    }
    ...
    protected void onStop(){
        super.onStop();
        Log.d(TAG, " onStop Learning Activity");
    }
    ...
    protected void onDestroy(){
        super.onDestroy();
        Log.d(TAG, " onDestroy Learning Activity");
    }
    ...
    protected void onRestart(){
        super.onRestart();
        Log.d(TAG, " onRestart Learning Activity");
    }
